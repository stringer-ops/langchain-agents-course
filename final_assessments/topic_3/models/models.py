...
class AnalysisConclusion(BaseModel):
    ...
    summary: str = Field(description="""
        A quick summary that supports the reasoning you have followed for setting the mark and explains why
...
class AnalysisResult(BaseModel):
    ...
    conclusion: AnalysisConclusion = Field(description="""
        Mark and summary if the applicant might get the job or not
    """)